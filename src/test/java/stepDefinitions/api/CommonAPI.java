...
public class CommonAPI {
    ...
    PojoHerokuappBookingDates bookingDates1;
    ...
    public void herokuapp_api_get_request_expected_body_hazirla() {
      bookingDates1            =new PojoHerokuappBookingDates("2018-01-01","2019-01-01");
      PojoHerokuappBooking pojoHerokuappBooking=new PojoHerokuappBooking("John","Smith",111,true,"Breakfast",bookingDates);
      PojoHerokuappExpectedBody pojoHerokuappExpectedBody1=new PojoHerokuappExpectedBody(1112,pojoHerokuappBooking);
...
response.then().assertThat().statusCode(200).body("bookingid",hasItem(1045));
